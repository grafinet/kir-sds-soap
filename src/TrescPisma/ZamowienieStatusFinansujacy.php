...
class ZamowienieStatusFinansujacy extends TrescPisma
{
    public const NAMESPACE_PREFIX = 'zsf';
    public const NAMESPACE_URI = 'https://www.kir.pl/SystemDokumentowStrukturyzowanych/ZamowienieStatusFinansujacy';
