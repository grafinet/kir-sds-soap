...
class OfertaStatusDealer extends TrescPisma
{
    public const NAMESPACE_PREFIX = 'osd';
    public const NAMESPACE_URI = 'https://www.kir.pl/SystemDokumentowStrukturyzowanych/OfertaStatusDealer';
