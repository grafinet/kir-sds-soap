...
class ZapytanieOfertoweStatusFinansujacy extends TrescPisma
{
    public const NAMESPACE_PREFIX = 'zosf';
    public const NAMESPACE_URI = 'https://www.kir.pl/SystemDokumentowStrukturyzowanych/ZapytanieOfertoweStatusFinansujacy';
