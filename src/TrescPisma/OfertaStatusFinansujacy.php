...
class OfertaStatusFinansujacy extends TrescPisma
{
    public const NAMESPACE_PREFIX = 'osf';
    public const NAMESPACE_URI = 'https://www.kir.pl/SystemDokumentowStrukturyzowanych/OfertaStatusFinansujacy';
