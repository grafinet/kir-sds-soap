...
class PotwierdzenieDanychPrzedmiotuStatusDealer extends TrescPisma
{
    public const NAMESPACE_PREFIX = 'pdpsd';
    public const NAMESPACE_URI = 'https://www.kir.pl/SystemDokumentowStrukturyzowanych/PotwierdzenieDanychPrzedmiotuStatusDealer';
